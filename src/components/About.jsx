...
const About = () => {
  return (
    <div name='about' className='w-full h-50 bg-gradient-to-b from-gray-700 to-black text-white pb-28 pt-10'>
        <div className='max-w-screen-lg p-4 mx-auto flex  flex-col w-full h-full'>
            <div className='pb-8 mx-auto text-center'>
                <p className='text-4xl text-gray-300 font-bold inline border-b-4 border-gray-500 p-auto'> About</p>
